...
vectors = ["llama-logprobs", "tinyllama-logprobs", "trigram-logprobs", "unigram-logprobs"]
...
def train_trigram(verbose=True, return_tokenizer=False, model_name = "meta-llama/Llama-2-7b-hf"):
    """
    ...
    for sentence in tqdm.tqdm(sentences):
        tokens = tokenizer(" ".join(sentence), add_special_tokens = False)
...
def get_all_logprobs(
    ...
    llama_logprobs, tinyllama_logprobs = {}, {}
    ...
    for file in to_iter:
        ...
        llama_logprobs[file] = get_logprobs(
            convert_file_to_logprob_file(file, "llama")
        )[:num_tokens]
        tinyllama_logprobs[file] = get_logprobs(convert_file_to_logprob_file(file, "tinyllama"))[
            :num_tokens
        ]
    ...
    return llama_logprobs, tinyllama_logprobs, trigram_logprobs, unigram_logprobs
...
def generate_symbolic_data(
    ...
    if vector_map is None:
        ...
        vector_map = {
            ...
            "tinyllama-logprobs": lambda file: tinyllama_logprobs[file],
        ...
        for i in range(1, len(exp_tokens)):
            if exp_tokens[i] in vec_functions:
                ...
                try:
                    ...
                    print(f"[ERROR] Exception occurred in file: {file}")
                    raise  
